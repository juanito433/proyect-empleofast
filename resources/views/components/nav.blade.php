...
<body>
    ...
    {{-- Navbar de los perfiles --}}
    <nav class="menu__wrapper">
        <div class="logo__wrapper">
            <a href="/app" title="Logo" class="logo">
        ...
        <div class="action-buttons">
            ...
            <img id="avatar-navbar" class="avatar-profile" src="{{ asset('images/burgerking.png') }}" alt="Profile" style="border-radius: 50%; object-fit: cover; width: 55px; height: 55px; margin-right: 20px;">
        </div>
    </nav>

    {{-- Menú de los perfiles --}}
